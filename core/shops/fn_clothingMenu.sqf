...
if((_this select 3) == "reb" && !license_cop_swat) exitWith {hint "Vous n'êtes pas GIGN"; closeDialog 0;};
if((_this select 3) == "gangster" && !license_civ_gangster) exitWith {hint localize "STR_Shop_NotaReb"; closeDialog 0;};
