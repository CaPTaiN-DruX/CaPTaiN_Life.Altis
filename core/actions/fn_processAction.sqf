...
_itemInfo = switch (_type) do
{
	...
	case "meth1": {["poudrehydroxyde","crystalmeth",3000,"Traitement de la Poudre Hydroxyde",false]};
	case "meth2": {["crystalmeth","crystalmethpur",3500,"Purification du Cristal de Meth",false]};
	case "silver": {["silver","silver_r",1120,"Traitement de l'Argent",false]};
	case "lsd": {["lsd","lsdp",1120,"Traitement du LSD",false]};
	case "ble": {["ble","pain",1120,"Traitement du Blé",false]};
	case "tabac": {["tabac","tabacp",1120,"Traitement du Tabac",false]};
	default {[];};
};
