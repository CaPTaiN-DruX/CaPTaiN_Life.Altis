...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","lsd_1","ble_1","tabac_1"];
_zone = "";
...
switch(true) do {
	...
	case (_zone in ["lsd_1"]): {_gather = "lsd"; _val = 1;};
	case (_zone in ["ble_1"]): {_gather = "ble"; _val = 2;};
