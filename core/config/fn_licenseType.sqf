...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "devs": {_var = "license_civ_devs"};
			case "luxe": {_var = "license_civ_luxe"};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_devs": {_var = "devs"};
			case "license_civ_luxe": {_var = "luxe"};
