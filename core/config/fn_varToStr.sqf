...
switch (_var) do
{
	...
	case "life_inv_kitmeth": {"Kit de Meth"};
	case "life_inv_crystalmeth": {"Crystal de Meth"};
	case "life_inv_crystalmethpur": {"Crystal de Meth Pur"};
	case "life_inv_poudrehydroxyde": {"Poudre d'hydroxyde"};
	case "life_inv_silver": {"Minerais d'Argent"};
	case "life_inv_silverr": {"Lingots d'Argent"};
	case "life_inv_lsd": {"LSD"};
	case "life_inv_lsdp": {"LSD Traité"};
	case "life_inv_kidney": {"Organe"};
	case "life_inv_henraw": {"Viande de Poules"};
    case "life_inv_roosterraw": {"Viande de Coqs"};
    case "life_inv_goatraw": {"Viande de Chèvres"};
    case "life_inv_sheepraw": {"Viande de Moutons"};
    case "life_inv_rabbitraw": {"Viande de Lapins"};
	case "life_inv_ble": {"Blé"};
	case "life_inv_pain": {"Sac de Farine"};
	case "life_inv_tabac": {"Tabac"};
	case "life_inv_tabacp": {"Tabac Traité"};
	...
	case "license_civ_devs": {"Permis Developpeur"};
    case "license_civ_luxe": {"Permis Voiture de Luxe"};
	case "license_civ_meth": {"Traitement de la Meth"};
	case "license_civ_bus": {"Chauffeur de Bus"};
	case "license_civ_lsd": {"Traitement de l'LSD"};
	case "license_civ_silver": {"Traitement de l'argent"};
	case "license_civ_gangster": {"Entrainement de Gangster"};
	case "license_civ_ble": {"Traitement du Blé"};
	case "license_civ_tabac": {"Traitement du Tabac"};
