...
_welcomeMessage = format["Bienvenue sur GeekForLife %1",format["%1", name player]];
_camDistance = 40;
...
["Bienvenue sur Geek For Life","CENTER_UP",2] call arjay_dynamicText;
...
_role1 = "Bienvenue sur Geek 4 Life";
_role1names = ["Un Serveur 100% FR et 100% RP"];
_role2 = "Site/Forum";
_role2names = ["www.geek-for-life.fr"];
_role3 = "TeamSpeak";
_role3names = ["ts3.geek-for-life.fr"];
_role4 = "Admins";
_role4names = ["Versus,Moimerlin01,Victomania,Darky"];
...
_finalText = format ["<t size='1' color='#FF8000' align='center'>%1<br /></t>", _memberFunction];
